...
const CheckApprovalSendOrNotMainDashboard = () => {
      ...
      <Container fluid className="operatorDashboard">
        <Row>
                ...
                return (
                  <MenuItem key={option.value} value={option.value}>
                    {option.label}
                          ...
                          subSectionList.sectionInfo.dashboardLevel ===
                          "Yes" ? (
                            ""
                          ) : (
                            <div sm={6} lg={4}>
          ...
          <Col
            ...
            md={12}
            xl={3}
            className="right-component-main-dashboard marginLeft"
...
export default CheckApprovalSendOrNotMainDashboard;
