...
const ImplementationApprovalDashboard = () => {
  ...
  const implementationApprovalDataOfCSV = [
    {
      label: "Month",
      key: "senderApprovalMonth",
    },
    {
      label: "Cell Name",
  ...
  const downloadPDFForImplementationApprovalData = () => {
    const doc = new jsPDF();
    let rows = [];
    ...
    doc.save(`Implementation_Approval_Data_${timeStamp()}`);
  };
  ...
  const actions = [
      ...
      onClick: (event, selectedRow) => {
        ...
        navigate("/viewCheckSheet", {
          state: {
            ...
            dashboardID: "FromImplementationApprovalDashboard",
          },
        });
        //   } else {
    ...
    },
    {
      ...
      isFreeAction: true,
      onClick: (event) => {
        downloadPDFForImplementationApprovalData();
      },
    },

    {
      icon: () => (
        <CSVLink
          headers={implementationApprovalDataOfCSV}
          className="downloadCSV text-decoration-none"
          data={tableData ? tableData : []}
          filename={`Implementation_Approval_Data_${timeStamp()}`}
      ...
      <div className="pageCard">
        <div className="creationDashboard">
          <h4 style={{ padding: "1rem 0 0 1rem" }}>
            Implementation Approval Dashboard
          </h4>
...
export default ImplementationApprovalDashboard;
