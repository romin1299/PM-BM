...
function UserAssigns() {
  ...
  //fetch the user data and show on user management table
  const fetchAssignUserInfo = async () => {
    try {
      const res = await fetch("/displayAssignUser", {
        method: "GET",
        headers: {
  ...
  const updateAssignUserInfo = async (updatedRow) => {
  ...
  const deleteAssignUserInfo = async (selectedRow) => {
          ...
          <div style={{ padding: "1rem" }}>
            <MaterialTable
              ...
              editable={{
                ...
                //     updateAssignUserInfo(updatedRow);
                //     setTimeout(() => {
                //       setTableData(updatedRows);
                //       resolve();
                //     }, 500);
