        ...
        <Grid lg={8} className="d-flex " gap={2}>
          ...
          <Box>
            <FormControl>
              <RadioGroup
                row
                name="involvingHandlingOfFlammableLiquid"
                defaultValue={"false"}
                onChange={(e) => {
        ...
        <Grid lg={8} className="d-flex " gap={2}>
          ...
          <Box>
            <FormControl>
              <RadioGroup
                row
                name="workInvolvingRiskOfOxygen"
                defaultValue={"false"}
                onChange={(e) => {
