...
const SafetyForm = ({ id, lineName, machineNo }) => {
  const {
    handleSubmit,
    control,
    watch,
    ...
    defaultValues: {
      ...
      workUsingHighVoltage: { IsAccepted: "", isAssociatesQualified: false },
      keyRisks: "",
      preventiveMeasures: "",
    },
  });
      ...
      <Grid container p={1} rowGap={2} className="border">
        ...
        <Grid sm={12}>
          <Box className="d-flex border  p-1 align-items-center">
            ...
            <Grid lg={8}>{lineName}</Grid>
            <Grid lg={4} fontWeight={650}>
              Machine No:
            </Grid>
            <Grid lg={8}>{machineNo}</Grid>
          </Box>
          <Box
            className="d-flex border p-1 border-top-0 align-items-center"
            fontWeight={600}
          >
            * Work instruction items (8 High risk works should be checked onsite
          ...
          {generalMaintainanceWorkValue === "true" && (
            <FormGroup>
              ...
              {errors.generalMaintainanceWork?.protectiveEquipment && (
                <FormHelperText error>
                  {errors.generalMaintainanceWork.protectiveEquipment.message}
                </FormHelperText>
              )}
              <Controller
              ...
              {errors.generalMaintainanceWork?.postNecessaryWarnigs && (
                <FormHelperText error>
                  {errors.generalMaintainanceWork.postNecessaryWarnigs.message}
                </FormHelperText>
              )}
              <Controller
        ...
        <Grid sm={12} className="border">
          <Box className="text-center w-100 border-bottom">
            <h4 style={{ fontSize: "20px" }}>High Risk Works (Work in pairs)</h4>
          </Box>
          <Grid sm={12} className="border">
            <Box className="d-flex p-1 align-items-center">
              <Grid lg={4} fontWeight={650}>
            ...
            {workHandlingHeavyObjValue === "true" && (
              <FormGroup>
                ...
                {errors.workHandlingHeavyObj?.visuallyGuessWeight && (
                  <FormHelperText error>
                    {errors.workHandlingHeavyObj.visuallyGuessWeight.message}
                  </FormHelperText>
                )}
                <Controller
                ...
                />
                {errors.workHandlingHeavyObj?.prohibitSlingOpWithSingleWire && (
                  <FormHelperText error>
                    {
                      errors.workHandlingHeavyObj.prohibitSlingOpWithSingleWire
                        .message
                ...
                />
                {errors.workHandlingHeavyObj?.secureFootingAndHandPosition && (
                  <FormHelperText error>
                    {
                      errors.workHandlingHeavyObj.secureFootingAndHandPosition
                        .message
          ...
          <Grid sm={12} className="border">
            ...
            {involvingHandlingOfFlammableLiquidValue === "true" && (
              <FormGroup>
                ...
                />
                {errors.involvingHandlingOfFlammableLiquid?.measureOxygen && (
                  <FormHelperText error>
                    {
                      errors.involvingHandlingOfFlammableLiquid.measureOxygen
                        .message
            ...
            {workUsingHighVoltageValue === "true" && (
              <FormGroup>
                ...
                {errors.workUsingHighVoltage?.isAssociatesQualified && (
                  <FormHelperText error>
                    {errors.workUsingHighVoltage.isAssociatesQualified.message}
                  </FormHelperText>
                )}
              </FormGroup>
            )}
