...
const sendApprovalOfSkippedPM = async (
  tm_no,
  tm_name,
  firstEmail,
  secondEmail,
  ...
  <tr>
    ...
    <td style="border: 1px solid black;text-align: left;padding: 8px;">${
      approvalStatusOfMTDHOS === "Accepted"
        ? "Accepted"
        : approvalStatusOfMTDHOS === "Rejected"
        ? "Rejected"
        : "Pending"
    }</td>
  </tr>
  ...
  <tr style="background-color: #dddddd;">
    ...
    <td style="border: 1px solid black;text-align: left;padding: 8px;">${
      approvalStatusOfMTDHOD === "Accepted"
        ? "Accepted"
        : approvalStatusOfMTDHOD === "Rejected"
        ? "Rejected"
        : "Pending"
    }</td>
  </tr>
  ...
  <tr>
      ...
      <td style="border: 1px solid black;text-align: left;padding: 8px;">${
        approvalStatusOfPRDHOS === "Accepted"
          ? "Accepted"
          : approvalStatusOfPRDHOS === "Rejected"
          ? "Rejected"
          : "Pending"
      }</td>
  </tr>
  ...
  <tr style="background-color: #dddddd;">
      ...
      <td style="border: 1px solid black;text-align: left;padding: 8px;">${
        approvalStatusOfPRDHOD === "Accepted"
          ? "Accepted"
          : approvalStatusOfPRDHOD === "Rejected"
          ? "Rejected"
          : "Pending"
      }</td>
  </tr>
      ...
      <td style="border: 1px solid black;text-align: left;padding: 8px;">${reasonForDelayOfTL}</td>
                      ...
                      <tr>
                          <td style="text-align:center;">
                              ...
                              } title="Denso" target="_blank" style="font-size:14px; color:black; line-height:18px; margin:0 0 0;">
