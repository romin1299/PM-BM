...
const getRequestSheetData = tryCatchHandler(async (req, res, next) => {
  ...
  let isEditableRS = {
    $cond: [
      ...
      {
        /**
         * PATHWAY 1: Generated/Assigned + No assigns yet + Date valid
         * If status is Generated/Assigned AND assignUserForCM array is empty AND
         * target date hasn't passed → Everyone can edit
         *
         * PATHWAY 2: User is assigned to this sheet
         * Filter assignUserForCM array for current user's ID
         * If array is not empty after filter → User is assigned
         */
        $or: [
          {
            $and: [
