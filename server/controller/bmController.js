...
router.get(
  ...
  async (req, res, next) => {
    ...
    const sectionWiseYearlyBDTrend = [
      // if(req.params.filterWise === "Plant"){
      {
        $facet: {
          plantHourlyData: [
      ...
      // if(req.params.filterWise === "Plant"){
      {
        $facet: {
          sectionHourlyData: [
            ...
            //   $project : {
            //     _id: 0,
            //     line_name : "$line_names.line_name"
            //   }
            // },
            ...
            // {
            //   $group: {
            //     _id: { lineName: "$lineRef", bdTime:  "$bdTime"  },
            //   },

            //   // sumofBdHours :  {
            //   //     $sum: {
            //   //       $cond: [{ $gt: ["$bdTime", 1] }, "$bdTime", 0],
            //   //     },
            //   //   },
            // },
            {
