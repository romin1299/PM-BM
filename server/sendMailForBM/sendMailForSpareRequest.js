...
const sendMailForSpareRequest = async ({subject, title, greetings, toEmailIds, ccEmailIds, bodyTable}) => {

    let emailConfData = await EmailConfigurationController()
    // console.log("toEmailIds-----> ", toEmailIds)
    // console.log("ccEmailIds ===========> ", emailConfData.emailPort)
    ...
    let mailOptions = {
        ...
        to: emailConfData.emailForSpareRequest, //toEmailIds
        subject: subject,
        html: `
        <!doctype html>
<html lang="en-US">
...
module.exports = sendMailForSpareRequest;