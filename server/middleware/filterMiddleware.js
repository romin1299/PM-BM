...
/** The CM sheet filter, as every existing route uses it. */
const filterMiddleware = createFilterMiddleware();

/** The same hierarchy filter for sheets that carry their timestamp at the root. */
filterMiddleware.forRootTimeStamp = createFilterMiddleware({
  timeStampAtRoot: true,
});
